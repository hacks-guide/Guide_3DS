...
Ανατρέξτε στον [οδηγό επίλυσης προβλημάτων](troubleshooting#boot-issues-on-consoles-with-custom-firmware). **Δεν προτείνεται η αφαίρεση του CFW όταν η κονσόλα σας βρίσκεται σε κατάσταση αδυναμίας εκκίνησης, καθώς είναι πολύ πιθανό να καταστεί μη λειτουργική**.
