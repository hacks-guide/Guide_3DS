...
:::: details Τι σημαίνει η «εξαγωγή» μιας κάρτας SD;
...
Στις περισσότερες συσκευές, η εφαρμογή διαχείρισης αρχείων έχει ένα κουμπί «Εξαγωγή» (⏏️) για την κάρτα SD σας. Η χρήση αυτής της επιλογής σταματά με ασφάλεια κάθε δραστηριότητα και αποπροσαρτά την κάρτα. ώστε να μπορεί να αφαιρεθεί.

Αυτό είναι **πολύ** σημαντικό επειδή η αφαίρεση της κάρτας SD ενώ είναι σε χρήση, μπορεί να προκαλέσει καταστροφή και να επηρεάσει αρνητικά το αποτέλεσμα των exploit όταν τροποποιείτε το 3DS σας.
