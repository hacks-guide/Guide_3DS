...
For technical details on the exploits that you will be using on this page, see the [GitHub page for SSLoth](https://github.com/MrNbaYoh/3ds-ssloth) as well as the [GitHub page for Universal Otherapp](https://github.com/TuxSH/universal-otherapp).
...
1. Tap the QR code button and scan [this QR code](http://api.qrserver.com/v1/create-qr-code/?color=000000&bgcolor=FFFFFF&data=https%3A%2F%2Fzoogie.github.io%2Fweb%2Fnbhax&qzone=1&margin=0&size=400x400&ecc=L).
    ...
    * If you get a crash or a different error code, follow the [troubleshooting guide](troubleshooting-ssloth-browser).
...
1. If the exploit was successful, you will have booted into SafeB9SInstaller.
    * If you get an error, follow the [troubleshooting guide](troubleshooting-ssloth-browser).
...
1. When prompted, input the key combo given on the top screen to install boot9strap.
    * If a step on the lower screen has red-colored text, and you are not prompted to input a key combo, follow the [troubleshooting guide](troubleshooting-ssloth-browser).
