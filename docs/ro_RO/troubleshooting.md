...
4. Copiați `TWLFix-CFW.3dsx` în folderul `/3ds/` de pe cardul SD
5. Reinsert your SD card into your console
6. Deschideți Homebrew Launcher-ul
7. Lansați TWLFix-CFW din lista de homebrew
8. Apăsați (A) pentru a dezinstala titlurile TWL defecte
