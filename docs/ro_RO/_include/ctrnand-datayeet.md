...
7. Selectați "Copy to 0:/gm9/out"
8. Apăsați (A) pentru a continua
9. While still highlighting `00010017`, press (X) to delete it
10. Apăsați (A) pentru a confirma
11. Apăsați (A) ca să deblocați scrierea în SysNAND (lvl1), apoi introduceți combinația de butoane care vi se cere
12. Once the file has been deleted, press (A) to continue
13. Apăsați (A) ca să reblocați permisiunile de scriere dacă vi se cere
