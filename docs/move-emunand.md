...
1. Hold `Right Shoulder + A` at the same time on `00030004` to select the folder, then select `Copy to 0:/gm9/out`.
...
1. Perform the following process for each GBA VC game that you would to create a save backup for:
...
1. Perform the following process for each GBA VC game that you would to restore a save backup for:
    * Launch the GBA VC game.
    * Exit the GBA VC game.
    * Boot your console while holding `START` to launch the Luma3DS chainloader menu.
    * Launch GodMode9 by pressing `A`.
...
1. Hold `Right Shoulder + B` at the same time to eject your SD card.
1. Insert your SD card into your computer.
