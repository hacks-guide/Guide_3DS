...
1. Perform the following process for each GBA VC game that you would like to create a save backup for:
...
1. Your encrypted / decrypted `.cia` will be output to the desired location.
