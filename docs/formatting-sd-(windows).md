...
* SD card remains undetected by console or continues to display the wrong capacity after formatting
    * Your SD card may be partitioned or have unallocated space. Follow the instructions on the [hacks.guide Wiki](https://wiki.hacks.guide/wiki/SD_Clean/Windows) to reformat your SD card.
