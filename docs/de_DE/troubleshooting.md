...
Diese Seite gibt Anweisungen und Lösungen für oft auftretende Fehler. Wenn diese Seite das Problem nicht lösen kann, tritt bitte [Nintendo Homebrew on Discord](https://discord.gg/MWxPgEp) und beschreibe dein Problem, zusätzlich mit dem, was du schon versucht hast.
...
Tritt [Nintendo Homebrew auf Discord](https://discord.gg/MWxPgEp) bei und beschreibe die Nachricht, die du siehst.
