...
1. When prompted, input the key combo given on the top screen to install boot9strap.
    * If a step on the lower screen has red-colored text, and you are not prompted to input a key combo, follow the [troubleshooting guide](troubleshooting-updating-b9s).
