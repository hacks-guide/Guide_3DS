...
For technical details on the exploits that you will be using on this page, see the [GitHub page for SoundHax](https://github.com/nedwill/soundhax) as well as the [GitHub page for Universal Otherapp](https://github.com/TuxSH/universal-otherapp).
