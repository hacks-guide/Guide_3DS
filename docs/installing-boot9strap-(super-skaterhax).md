...
For technical details on the exploits that you will be using on this page, see the [GitHub page for Super Skaterhax](https://github.com/zoogie/super-skaterhax).
...
A video detailing these steps is available [on YouTube](https://www.youtube.com/watch?v=DEcZB72vJts).
