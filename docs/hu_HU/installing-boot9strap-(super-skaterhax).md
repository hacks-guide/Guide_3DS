...
Ez a metódus jelenleg **nem működik** a szerver oldali SSL tanúsítvány változások miatt. A javítás várható ideje ismeretlen. Addig kövesd a [Boot9strap telepítését (MSET9)](installing-boot9strap-\(mset9\)) helyette.
