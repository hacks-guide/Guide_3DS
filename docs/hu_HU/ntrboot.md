...
| **R4i Gold 3DS Plus** (r4ids.cn)                                                         |                        |                                    Nem                                    |                                      MIND                                     |                                MIND                               | **ntrboot-tal előre flashelve** ([belső kapcsolóval váltogatható az ntrboot és az NDS mód](/images/screenshots/r4i-gold-3ds)); ne flasheld kézileg ntrboot-tal.                                                                                                                              |
