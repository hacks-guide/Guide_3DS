...
If your console is on system version 9.4.0, 9.5.0, or 9.6.0, you may be encountering a bug with an old version of universal-otherapp. Download the latest version from [GitHub](https://github.com/TuxSH/universal-otherapp/releases/latest).
...
You may also have the wrong Soundhax file for your console, region and version. Verify that your console details are correct and redownload your Soundhax file from the [Soundhax website](http://soundhax.com), then place it on the root of your SD card, replacing the existing one.

If the above doesn't fix your issue, and you are using an Old 3DS / Old 3DS XL / Old 2DS, you may be encountering an issue involving cartridge updates. Take another look at the system version. If the number before the letter is 4 or lower (e.g. 11.3.0-**4**U), replace the Soundhax file on the root of your SD card with the one from the [Soundhax website](http://soundhax.686178.xyz/frankenfirm.html?crash).
...
You have the wrong Soundhax file for your console, region and version. Verify that your console details are correct and redownload your Soundhax file from the [Soundhax website](http://soundhax.com), then place it on the root of your SD card, replacing the existing one.

If the above doesn't fix your issue, and you are using an Old 3DS / Old 3DS XL / Old 2DS, you may be encountering an issue involving cartridge updates. Take another look at the system version. If the number before the letter is 3 or lower (e.g. 11.3.0-**0**U), replace the Soundhax file on the root of your SD card with the one from the [Soundhax website](http://soundhax.686178.xyz/frankenfirm.html?unplayable).
