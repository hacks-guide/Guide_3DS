...
$(document).ready(function() {
  ...
  var methods = {
    ...
    "installing-boot9strap-(soundhax-sp-twn)": "19",
    "seedminer-(twn)": "20"
  };
  ...
  if(sidebar_shown){
    ...
    var device_common = {
      ...
      "19": ["installing-boot9strap-(soundhax-sp-twn)", "finalizing-setup"],
      "20": ["seedminer-(twn)", "bannerbomb3-fredtool-(twn)", "finalizing-setup"]
    }
