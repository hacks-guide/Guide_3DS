...
** Η πραγματοποίηση μίας μεταφοράς του ctr θα αφαιρέσει όλα τα tickets, τα οποία εγκαταστάθηκαν από τον χρήστη, από την συσκευή ωσότου γίνει επαναφορά των αντιγράφων ασφαλείας. Under NO CIRCUMSTANCES should you skip creating the backup, or you will LOSE access to all installed games and saves!** {: .notice--danger}
