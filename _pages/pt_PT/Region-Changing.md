...
title: "Region Changing" permalink: /region-changing.html lang: en_US ref: region-changing
...
**Mudança de Região é quase completamente desnecessário agora, já que o Luma3DS suporta jogos de outra região e [emulação de região para títulos](https://github.com/AuroraWright/Luma3DS/wiki/Options-and-usage) individualmente.** {: .notice--info}

Este processo irá desvincular o seu NNID do sistema, uma vez que não será mais compatível com ele. NNID's are locked to the region of the device that created them, and cannot be transferred between regions without [a very complex and advanced process](https://gist.githubusercontent.com/yifanlu/e80db121d38aceb8cca0e03cefd5853b/raw/3c4dd89869156ca0f945a2791e699acfdb32b510/gistfile1.txt). {: .notice--warning}
...
Old 3DSs / 2DSs may need to format (using TinyFormat or the System Settings) to play extended memory mode games (such as Monster Hunter, Super Smash Bros, or Pokemon Sun/Moon). {: .notice--info}
