...
Se não sabe que versão do arm9loaderhax tem a correr, apenas instale a última versão com estes passos. Installing the latest version while already on the latest version will have no effect. {: .notice--info}
