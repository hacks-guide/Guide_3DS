...
A sua consola pode não mostrar os seus jogos instalados depois da ctrtrasnfer. Isto é devido aos tickets terem sido removidos durante a transferência, e por isso é que você cria uma cópia destes. Eles serão restaurados no fim do guia. {: .notice--info}
