...
Yarr matey, if ye've derngraded to ye olde 2.1.0 on a flatbrick or new 3d thingy and left yer wireless off, remove that scallywag of a battery, wait yerself a few seconds, then press yer power button {: .notice--info}

Ya may need yerself a good ol' microSD reader matey. {: .notice--info}
