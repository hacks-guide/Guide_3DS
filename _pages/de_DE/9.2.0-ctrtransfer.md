...
##### Abschnitt III - ctrtransfer
  ...
  2. Bei Nachfrage, wähle das 9.2.0 ctrtransfer Abbild aus, indem du (A) drückst.
...
##### Abschnitt V - FBI injizieren
  ...
  1. Navigiere zu "SysNAND Options", dann "Miscellaneous", und wähle dann "Health&Safety Dump" aus, um die Gesundheits- und Sicherheitsinformationen App als `hs.app` zu dumpen **(Du kannst Oben und Unten / Links und Rechts benutzen, um den Namen zu ändern)**
