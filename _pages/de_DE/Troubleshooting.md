...
Falls du nicht in der Lage bist deinen 3DS zu starten, suche bitte die Sektion, welche für dich relevant ist und folge den Anweisungen. Sobald eine Lösung für dich funktioniert hat, kannst du mit der Hauptanleitung fortfahren. (Diese Sektion is ziemlich lang also versuch dein Problem mit Strg + F zu suchen.) {: .notice--primary}

**Falls du dein Problem immernoch nicht lösen kannst und du Hilfe einer Person brauchst, kopiere bitte die Inhalte der relevanten .log Dateien vom Root deiner SD Karte in ein [Gist](https://gist.github.com/) und bereite dich auf die Hilfe mit einer detaillierten Beschreibung deines Problems, und dem, was du bisher versucht hast, vor.** {: .notice--info}

## <a name="twl_broken" />DSi / DS Funktionalität ist nach dem Ausführen der Anleitung kaputt

#### Was du brauchst

* Die TWL_FIRM `.cia` für deine Konsole 
