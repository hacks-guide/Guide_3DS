...
Wenn du bisher die integrierte microSD-Verwaltung des New 3DS verwendet hast um Dateien zu verschieben, benötigst du ab jetzt einen microSD Card Reader, da die Verwaltungsfunktion mit der Firware 2.1.0 nicht mehr kompatibel ist. {: .notice--info}
...
**Falls du nicht weißt ob du jetzt schon eine Sicherung gemacht hast, erstelle eine durch das Drücken von (A), sobald du dazu aufgefordert wirst; nur um sicher zu gehen.** {: .notice--danger}
