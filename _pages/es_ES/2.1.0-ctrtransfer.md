...
Si usted ha estado usando la función del New3DS de Administración de la tarjeta microSD, esta no va a funcionar en la versión 2.1.0, asegurese de tener un adaptador de microSD a SD antes de continuar. {:.notice--info}. {: .notice--info}

Su dispositivo puede no mostrar sus juegos instalados despues del ctrtransfer. This is due to the tickets being removed by the transfer, which is why you back them up. They will be restored at the end of the guide. {: .notice--info}
