...
**Performing a ctrtransfer will remove all user-installed tickets from the device until a backup is restored. ¡Por NINGUNA CIRCUNSTANCIA deberías saltar el hacer una copia de seguridad ! o PERDERÁS el acceso a todos los juegos instalados y partidas!** {: .notice--danger}
