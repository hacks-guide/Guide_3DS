...
Si has bajado de versión a la versión 2.1 pero por alguna razón **no dispones de una copia de seguridad de la NAND**, esta guía es para ti. {: .notice--success}

Tu dispositivo puede que no muestre los juegos que has instalado tras el ctrtransfer. Esto es debido a que los tickets son borrados por la transferencia, razón por la cual harás una copia de seguridad. Se restaurarán al final de la guía. {: .notice--info}

Because the point of the 9.2.0 ctrtransfer is to troubleshoot issues caused by the existing NAND, these steps, unlike the 2.1.0 ctrtransfer, will have you backup only the tickets and config save. Failure to back these up will result in the LOSS of all installed games and saves! {: .notice--danger}

#### Lo que necesitas

* La última versión de [Decrypt9WIP](https://github.com/d0k3/Decrypt9WIP/releases/latest)
* La última versión de [Decrypt9WIP](https://github.com/d0k3/Decrypt9WIP/releases/latest)
* La imagen 9.2.0 ctrtransfer para tu dispositivo y región  
    *(si tu dispositivo no es de una de estas regiones, sólo debes elegir uno que coincida con el tipo de dispositivo)*: 
...
##### Sección I - Preparativos
  ...
  2. Copy the 9.2.0 ctrtransfer image `.bin` and `.bin.sha` from the ctrtransfer `.zip` to the `/files9/` folder on your SD card
...
##### Sección II - Copia de seguridad de los tickets y del config save
...
##### Sección IV - Restaurar config save
...
##### Sección VI - Reinstalación de tickets
...
Formatear un dispositivo después de un ctrtransfer *sin restaurar la config save* puede causar problemas en el brillo de la pantalla / parpadeo. Ver [esto](https://github.com/Plailect/Guide/issues/794). {: .notice--info}

Volver a [instalar arm9loaderhax](installing-arm9loaderhax).{: .notice--primary}