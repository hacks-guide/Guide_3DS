...
Si vous downgradez une 2DS ou une New 3DS en 2.1.0 et que vous n'aviez pas activez le wifi, vous pourrez l'activez en enlevant la batterie pendant secondes puis en redémarrant.{: .notice--info}
...
Votre console pourrait ne plus afficher les jeux que vous aviez installé une fois le ctrtransfer terminé. C'est du à la suppression des tickets durant le transfère, c'est pourquoi vous les sauvegardez. Ils seront restaurés à la fin du guide. {: .notice--info}
