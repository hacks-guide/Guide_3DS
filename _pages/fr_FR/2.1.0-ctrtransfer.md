...
**L'exécution du ctrtransfer supprimera tout les tickets installer par l'utilisateur de la console, tant qu'une sauvegarde n'est pas restoré. Under NO CIRCUMSTANCES should you skip creating the backup, or you will LOSE access to all installed games and saves!** {: .notice--danger}
