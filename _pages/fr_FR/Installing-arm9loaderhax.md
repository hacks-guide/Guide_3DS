...
Ceci va installer le [fork d'AuroraWright](https://github.com/AuroraWright/arm9loaderhax) d'arm9loaderhax. {: .notice--info}

Nous allons également configurer la possibilité de lancer des payloads à partir d'arm9loaderhax, nous donnant la possibilité de débricker notre SysNAND dans des situations qui nous brickerait en temps normal en restaurant à partir d'une sauvegarde. {: .notice--info}

**Vous ne pouvez pas utiliser l'OTP d'une autre console ou vous allez la bricker , c'est GARANTI.** {: .notice--danger}
...
* **FBI** *(installe des applications et jeux en CIA)*
* **Luma3DS Updater** *(met notre CFW à jour facilement)*
* **Hourglass9** *(un outil multifonction)*
...
* Le dernier fork de [SafeA9LHInstaller](https://github.com/Plailect/SafeA9LHInstaller/releases/latest) *(le fichier `.7z`)*
* La dernière version de [arm9loaderhax](https://github.com/AuroraWright/arm9loaderhax/releases/latest) *(le fichier `.7z`)*
...
* La dernière version de [Updater Luma3DS](https://github.com/Hamcha/lumaupdate/releases/latest)
