...
* Siste utgave av [autofirm](https://github.com/Plailect/autofirm/archive/master.zip)
* Siste utgave av [3DSident](https://github.com/joel16/3DSident/releases/latest)
...
##### Section I - NAND modification
  ...
  3. Kopier innholdet av NFIRM `.zip` til `/autofirm/source/firmwares/` mappen
  ...
  * Behold `backup_nand.bin`, den vil bli brukt senere
