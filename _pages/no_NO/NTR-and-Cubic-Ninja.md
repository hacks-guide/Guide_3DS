...
title: "NTR and Cubic Ninja" permalink: /ntr-and-cubic-ninja.html lang: en_US ref: ntr-and-cubic-ninja
...
##### Section II - Updating
  ...
  2. Avslå oppdateringen og omstart
  3. Åpne Cubic Ninja (Hvis du allerede har NinjHax installert, hold (L)+(R)+(X)+(Y) for å tilbakestille)
  4. Velg "Create", deretter "QR Code", så "Scan QR Code"
  5. Skan QR-koden i NTR CFW `.zip` for din region
  ...
  9. Kjør NTR Debugger på datamaskinen din
