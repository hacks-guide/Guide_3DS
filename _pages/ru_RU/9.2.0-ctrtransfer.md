...
После ctrtransfer ваше устройство может перестать отображать установленные игры. Это происходит из-за удаленных в процессе тикетов. Внимательно следуйте инструкции. Мы уже сделали резервные копии тикетов и вскоре их восстановим. {: .notice--info}
