...
**NTR Cubic Ninja сработает ТОЛЬКО на JPN New 3DS!** {: .notice--warning}
...
* [NTR CFW](https://github.com/44670/BootNTR/releases/tag/3.2) версии v3.2
...
* Пакет обновления 9.2.0 `в .zip-архиве` для Вашего устройства и региона:  
